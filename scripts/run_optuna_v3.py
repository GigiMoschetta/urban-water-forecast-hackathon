"""Optuna hyperparameter tuning for Model v3 (direct LightGBM).
...
# Pre-build fold data to avoid recomputation
...
study = optuna.create_study(direction="minimize", study_name="v3_tuning")
